...
optimizer = optim.SGD(model.parameters(), lr=0.1, momentum=0.5, weight_decay=0)
...
trainOutput = open("trainOutput2layer.csv","w")
testOutput = open("testOutput2layer.csv","w")
