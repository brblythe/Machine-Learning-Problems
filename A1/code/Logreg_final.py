...
choice = int(input('input 1 for grad descent without \nregularization or other for regularized grad descent: '))

#Run iterative gradient descent without normalization modification
if choice == 1:
...
#Run iterative gradient descent with normalization modification
else:
	#Run iterative gradient descent
	#for j in range(max_iterations):
	ftrain = open('trainOutput.csv', 'w+')
